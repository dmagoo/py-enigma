...
from encipherers import glyph_to_ord, ord_to_glyph, glyph_pairs_to_map_string, rotate_list
...
class TestCalc(unittest.TestCase):
    ...
    def test_glyph_pairs_to_map_string(self):
        ...
        self.assertEqual(glyph_pairs_to_map_string([("z","a"),("b","y")]), swap_string)
        self.assertEqual(glyph_pairs_to_map_string([("a","z"),("b","y")]), swap_string)

    def test_rotate_list(self):
        self.assertEqual(rotate_list(IDENTITY_MAP_STRING, 4), "EFGHIJKLMNOPQRSTUVWXYZABCD")
        self.assertEqual(rotate_list(IDENTITY_MAP_STRING, -4), "WXYZABCDEFGHIJKLMNOPQRSTUV")
